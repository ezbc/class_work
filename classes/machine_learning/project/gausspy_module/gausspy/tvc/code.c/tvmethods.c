...
void tv_Kf (double *f, double *Kf, tv *t)
{
  ...
  /*memcpy (Kf, f, (size_t)t -> n * sizeof (double));*/
...
void tv_Ktransf (double *f, double *Ktransf, tv *t)
{
  ...
  /*memcpy (Ktransf, f, (size_t)t -> n * sizeof (double));*/
...
void tv_solve (tv *t)
{
  ...
  /*tv_test_derivatives (t -> v, t); exit (0);*/
